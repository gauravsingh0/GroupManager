...
Made from the source code of [♕︎╚«𝐺𝑅𝐵»╝⫸༒︎᯾«𝑃𝑅♢𝐹Ξ𝑆𝑆♢𝑅»᯾༒︎](t.me/Black_heart_hacker_xon)

Special thanks to [this person](t.me/piroXpower) for helping me.

Join for support [Here](https://t.me/yone_support_official)

Updates [Here](https://t.me/grb_network).

Click /help or Help button below to find out more about how to use me to my full potential.

 Add me to a group by clicking [here](http://t.me/pyratesX_robot?startgroup=true).
"""
